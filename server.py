...
def client_handler(conn, addr):
    ...
    while(True):
        ...
        if mode == 1:
                    ...
                    try:
                        ...
                        if current_player == conn: 
                            ...
                            if message['action'] == 'guess':
                                ...
                                print(f"Le client {addr} a quitté la partie.")
                                break
                        #send_message(conn, {'message': 'BBBB'})
            ...
            broadcast_to_players(game_id, {'message': 'Le jeu est fini !'})
